                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            {filters.intent && (
                                <span className="px-2 py-1 bg-green-500/20 text-green-400 text-xs rounded-full flex items-center gap-1">
                                    {filters.intent === 'STUDY' && <><GraduationCap className="w-3 h-3" /> Học tập</>}
                                    {filters.intent === 'DATE' && <><Heart className="w-3 h-3" /> Hẹn hò</>}
                                    {filters.intent === 'FRIEND' && <><Users className="w-3 h-3" /> Kết bạn</>}
                                </span>
                            )}
