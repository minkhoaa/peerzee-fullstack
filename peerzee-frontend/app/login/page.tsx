  ...
  return (
    <AuthCard>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex justify-between items-center ml-4 mr-4">
            <label className="text-[#3E3229] font-bold text-sm">
              Password
            </label>
            <a href="#" className="text-xs text-[#CD6E67] font-semibold hover:underline">
              Forgot?
            </a>
          </div>
          <input
      ...
      <div className="text-center mt-6 text-[#7A6862] font-semibold">
        ...
        <Link href="/register" className="text-[#CD6E67] font-bold hover:underline ml-1">
          Sign Up
        </Link>
      </div>
    </AuthCard>
