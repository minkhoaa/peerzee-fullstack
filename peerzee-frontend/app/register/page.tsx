...
export default function RegisterPage() {
  ...
  return (
    <AuthCard>
      ...
      {/* Form */}
      <form onSubmit={handleSubmit} className="space-y-4 max-h-[420px] overflow-y-auto pr-2 retro-scrollbar">
        {/* Email Input */}
      ...
      <div className="mt-6">
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-retro-paper font-pixel text-cocoa-light uppercase tracking-wider text-xs">
              Or Join With
            </span>
          </div>
        </div>
        ...
        <div className="flex gap-4 justify-center mt-4">
          <button
            type="button"
            className="w-12 h-12 bg-retro-white border-3 border-cocoa rounded-lg shadow-pixel-sm flex items-center justify-center text-cocoa hover:bg-pixel-blue hover:translate-y-[-2px] active:translate-y-1 active:shadow-none transition-all"
          >
            {SocialIcons.google}
          </button>
          <button
      ...
      {/* Toggle to Login */}
      <div className="text-center mt-4 font-body text-cocoa-light font-bold text-sm">
        Already a player?
        <Link href="/login" className="font-pixel text-pixel-pink-dark hover:text-pixel-pink uppercase tracking-wider ml-2">
          SIGN IN →
        </Link>
      </div>
    </AuthCard>
